package com.kaizensoftware.pokerpay.app.config.files.minio.http;

import io.minio.errors.*;
import io.minio.messages.Bucket;

import com.kaizensoftware.pokerpay.app.config.files.minio.service.MinioTemplate;
import com.kaizensoftware.pokerpay.app.config.files.minio.dto.*;
...
@RestController
@RequestMapping("/api-pokerpay/${minio.endpoint.name:/minio}")
